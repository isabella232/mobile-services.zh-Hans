...
1. 完成以下任务之一：
   ...
   * Sign in to Adobe Mobile Services and click **[!UICONTROL Create New]**.
      ...
      有关登录到Mobile Services UI的详细信息，请参阅登 [录](/help/using/gs/gs-signin.md)。

   * 要添加应用程序，请在左侧导航菜单中，单击“管 **[!UICONTROL 理应用程序]** ”，然后单 **[!UICONTROL 击“添加”]**。
...
1. 完成以下任务：
   ...
   * 按应用程序商店名称搜索并选择应用程序。
      ...
      您可以预览有关所选应用程序的信息，这有助于您确定是否选择了正确的应用程序。
