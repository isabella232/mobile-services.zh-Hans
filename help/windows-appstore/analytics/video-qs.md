...
在《Adobe Analytics测量音频和视频》指 [南中，对视频测量进行了详细](https://docs.adobe.com/content/help/zh-Hans/media-analytics/using/media-overview.html/) 描述。 在所有AppMeasurement平台上，衡量视频的一般过程都非常相似。 此快速开始部分提供开发人员任务的基本概述以及代码示例。
