...
* **loadRequest**
   ...
   * 以下是此方法的代码示例：
      ...
      有关基础Target API的更多信息，请参阅 [加载Target请求](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-target/target-api-reference-deprecated#load-target-requests) （在Target API引用中）。
